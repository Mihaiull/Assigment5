...
def generator(repository, numberOfDepartaments = 15, maxNumberOfPatients = 20):
    ...
    disease_dict = {1:'Cancer', 2:'Ligma', 3:'Laringita', 4:'Covid-19', 5:'Utilizator Arch Linux', 6:'Manelist', 7:'Windows enjoyer', 8:'Boala Copiilor', 9:'Conducator BMW', 10:'Conducator Audi', 11:'Bombardier', 12:'Nu stie sa numere indexurile la dict',13:'Mort', 14:'Viu', 15:'Impiedicat', 16:'Analfabet'}
